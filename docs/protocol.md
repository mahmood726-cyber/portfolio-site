        # Portfolio Site: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/portfolio-site.git

        ## Objective

        Portfolio Site is the personal academic and research portfolio website for Mahmood Ahmad, showcasing meta-analysis tools, publications, and open-source projects.
        ...
        - Code: https://github.com/mahmood726-cyber/portfolio-site.git
        - Dashboard: https://mahmood726-cyber.github.io/portfolio-site/
